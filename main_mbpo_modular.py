...
from model import EnsembleDynamicsModel, ModularEnsembleDynamicsModel
...
def train(args, env_sampler, predict_env, agent, env_pool, model_pool):
    writer = SummaryWriter("./logs/modular/8")
    total_step = 0
    reward_sum = 0
    rollout_length = 1
...
def main(args=None):
    ...
    if args.model_type == 'pytorch':
        env_model = ModularEnsembleDynamicsModel(args.num_networks, args.num_elites, state_size, action_size, args.reward_size, args.pred_hidden_size,
